 ...
 * @swagger
 * tags:
 *   name: Admin Courier Management Operations
 *   description: Admin Courier Management Operations - Overview stats, drivers list, active deliveries, and delivery history
 */
...
/**
 * @swagger
 * /api/admin/courier-management-operations/stats:
 *   get:
 *     summary: Get courier management overview statistics
 *     tags: [Admin Courier Management Operations]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 ...
 *               dailyRevenue: 4850
 */
router.get('/courier-management-operations/stats', getCourierStats);

/**
 * @swagger
 * /api/admin/courier-management-operations/drivers:
 *   get:
 *     summary: Get courier drivers list with filters
 *     tags: [Admin Courier Management Operations]
 *     security:
 ...
 *                 pages: 1
 */
router.get('/courier-management-operations/drivers', getCourierDrivers);

/**
 * @swagger
 * /api/admin/courier-management-operations/active-deliveries:
 *   get:
 *     summary: Get currently active deliveries with map data and live feed
 *     tags: [Admin Courier Management Operations]
 *     security:
 ...
 *                 fare: 12.50
 */
router.get('/courier-management-operations/active-deliveries', getActiveDeliveries);

/**
 * @swagger
 * /api/admin/courier-management-operations/delivery-history:
 *   get:
 *     summary: Get delivery history with filters
 *     tags: [Admin Courier Management Operations]
 *     security:
 ...
 *                 pages: 1
 */
router.get('/courier-management-operations/delivery-history', getDeliveryHistory);
